...
$id=intval($_GET['id']);
global $dbh;
$sql="update tblvehicles set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,$boite=:boite,$nbr_portes=:nbr_portes,$transmission=:transmission,$carrosserie=:carrosserie,$nbr_cylindres=:nbr_cylindres,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats where id=:id ";
...
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" required>
    ...
    <label class="col-sm-2 control-label">Boîte<span style="color:red">*</span></label>
    <div class="col-sm-4">
        <input type="text" name="boite" class="form-control" value="<?php echo htmlentities($result->boite);?>" required>
    </div>
    <label class="col-sm-2 control-label">Carrosserie<span style="color:red">*</span></label>
    <div class="col-sm-4">
        <input type="text" name="carrosserie" class="form-control" value="<?php echo htmlentities($result->carrosserie);?>" required>
    </div>
    <label class="col-sm-2 control-label">Nombre de portes<span style="color:red">*</span></label>
    <div class="col-sm-4">
        <input type="text" name="nbr_portes" class="form-control" value="<?php echo htmlentities($result->nbr_portes);?>" required>
    </div>
    ...
    <label class="col-sm-2 control-label">Nombre de cylindres<span style="color:red">*</span></label>
    <div class="col-sm-4">
        <input type="text" name="nbr_cylindres" class="form-control" value="<?php echo htmlentities($result->nbr_cylindres);?>" required>
    </div>
